...
const headingClass =
  "font-display text-3xl font-bold tracking-tight sm:text-[2.5rem]";
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <ScrollReveal>
            <div>
              ...
              <div
              className="mt-4 h-1 w-16 max-w-full rounded-full bg-gradient-to-r from-amber-300 via-amber-200 to-blue-500 shadow-sm shadow-amber-500/20"
                aria-hidden
              />
              ...
              <div>
                <dt className="text-xs font-semibold uppercase tracking-wider text-amber-100">
                  Phone
                </dt>
                <dd className="mt-1">
                  <a
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="sm:col-span-1">
                ...
                <input
                  ...
                  type="text"
                  autoComplete="name"
                  className="min-h-12 w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-base text-white outline-none ring-amber-300/40 focus:ring-2"
                />
              </label>
              <label className="sm:col-span-1">
                <span className="mb-1.5 block text-sm font-medium text-slate-300">
              ...
              <label className="sm:col-span-2">
                ...
                <textarea
                  name="details"
                  rows={5}
                  className="min-h-[8.5rem] w-full resize-y rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-base text-white outline-none ring-amber-300/40 focus:ring-2"
                />
              </label>
            </div>
            <button
              type="submit"
              className="mt-6 min-h-[52px] w-full rounded-full bg-cta py-3.5 text-base font-bold text-cta-foreground shadow-lg shadow-amber-950/35 transition-all duration-200 active:bg-amber-500 hover:-translate-y-0.5 hover:bg-cta-hover sm:w-auto sm:px-10"
            >
              Open email to send
            </button>
